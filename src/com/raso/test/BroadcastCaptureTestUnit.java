...
public class BroadcastCaptureTestUnit extends TestUnitDecorator {
	
	private final String TAG = "BroadcastCaptureTestUnit";
	...
	public BroadcastCaptureTestUnit(TestUnit testUnit) {		
		super(testUnit);
	}
